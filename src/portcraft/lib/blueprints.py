...
class TaskPacker:
    def __init__(self, module_name, module_args, module_plugins: dict = None, e_vars=None, module_comment=None):
...
class Blueprint:
    ...
    def __init__(self, filename=None, debug=None, ignore_errors=None):
    ...
    def run(self, filename=None):
        ...
        for stage_name, stage_data in stages.items():
            ...
            for module in stage_data:
                ...
                code = task.run()
                if code >= 1 and self._ignore_errors:
                    break
